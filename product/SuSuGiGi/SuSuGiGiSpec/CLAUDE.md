...
股權與財務管理已移至公司層級，位於 `finance/`（相對於 ai-company 根目錄）。

---

## 目錄結構

- **no1_production_management** — 產品管理
...
Product Map 位於 `no1_production_management/no2_product_planning/no2_product_map/`，依平台拆分：
